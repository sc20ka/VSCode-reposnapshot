...
function removeAttendeeFromEvent(eventId, attendeeName) {
    for (let i = 0; i < events.length; i++) {
        if (events[i].id === eventId) {
            ...
            events[i].attendees = events[i].attendees.filter((a) => a !== attendeeName);
...
// Example usage
add_event("Team Meeting", new Date("2023-06-15T10:00:00"), ["Alice", "Bob", "Charlie"], "Conference Room A", "meeting");
add_event("JavaScript Workshop", new Date("2023-06-20T14:00:00"), ["David", "Eve"], "Training Center", "workshop");
console.log("All events:", events);
addAttendeeToEvent(1, "Frank");
console.log("Events after adding Frank:", events);
//# sourceMappingURL=next-edit-4-2.js.map