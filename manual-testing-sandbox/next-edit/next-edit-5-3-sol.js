...
exports.ShoppingCart = exports.PRODUCTS = exports.DISCOUNT_CODES = exports.cart = void 0;
// Product catalog
const PRODUCTS = {
    1: {
        id: 1,
...
class ShoppingCart {
    ...
    applyCategoryDiscount(total, discount) {
        let categoryTotal = 0;
    ...
    applyDiscountCode(code) {
        ...
        if (this.total < discount.minPurchase) {
            console.error(`Minimum purchase of $${discount.minPurchase} required for this code!`);
            return false;
        }
        // Apply discount code
...
*/
//# sourceMappingURL=next-edit-5-3-sol.js.map